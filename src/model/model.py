...
def load_dataset(INPUT_PATH: str, DATASET_FILENAME: str, TEST_PERSON_IDS: str):
    ...
    df_test = df[df["person_source_value"].isin(subject_id)].copy()
...
def train_model(dataset_filename=""):
    ...
    # Works well with step 5.
    # class_weights = {0: 0.6649099981884357, 1: 2.015978429120687}

    # Works well with step 1.
    class_weights = {0: 0.6650110411654198, 1: 2.0150501338233533}
